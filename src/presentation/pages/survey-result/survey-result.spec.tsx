...
import {
  mockAccountModel,
  LoadSurveyResultSpy,
  mockSurveyResultModel, SaveSurveyResultSpy
} from '@/domain/test'
...
describe('SurveyResult Component', () => {
  ...
  test('Should render error on UnexpectedError', async () => {
    ...
    expect(screen.queryByTestId('answers')).not.toBeInTheDocument()
    expect(screen.queryByTestId('loading')).not.toBeInTheDocument()
  ...
  test('Should render error on UnexpectedError', async () => {
    const saveSurveyResultSpy: SaveSurveyResultSpy = new SaveSurveyResultSpy()
    const error = new UnexpectedError()
  ...
  test('Should present SurveyResult data on SaveSurveyResult success', async () => {
    ...
    const answersWrapResult = screen.queryAllByTestId('answer-wrap')
    expect(answersWrapResult[0]).toHaveClass('active')
    expect(answersWrapResult[1]).not.toHaveClass('active')
